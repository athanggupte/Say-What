    ...
    def replan_before_action(self):
        ...
        if isinstance(self.datum, ObjDesc):
            ...
            if not target_pos:
                ...
                return
        elif isinstance(self.datum, roomgrid.WorldObj):
        ...
        if np.array_equal((next_cell[0] - self.pos[0], next_cell[1] - self.pos[1]), self.right_vec):
            # print(next_cell)
            # print(self.pos)
            return self.actions.right
        elif np.array_equal((next_cell[0] - self.pos[0], next_cell[1] - self.pos[1]), -self.right_vec):
            return self.actions.left
...
class Bot:
    ...
    def __init__(self, mission):
        ...
        self.grid = roomgrid.Grid(mission.width, mission.height)
