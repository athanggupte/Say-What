...
class SayWhat_Agent:
    ...
    def __init__(self, obs_space, action_space, model_dir, action_model,
                 argmax=False, num_envs=1, use_memory=False, use_text=False):
        obs_space, self.preprocess_obss = utils.get_obss_preprocessor(obs_space)
        self.acmodel = SayWhat_ACModel(obs_space, action_space, use_memory=use_memory, use_text=use_text)
        setattr(self.acmodel, "action_model", action_model)
        self.argmax = argmax
        self.num_envs = num_envs
